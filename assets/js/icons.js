...
window.Icon = ({ path, className = "h-4 w-4" }) => (
...
window.Icons = {
    ...
    MoveUp: <path d="M12 19V5M5 12l7-7 7 7" />,
    MoveDown: <path d="M12 5v14M5 12l7 7 7-7" />,
    ...
    CheckCircle2: <g><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14" /><polyline points="22 4 12 14.01 9 11.01" /></g>,
    ...
    FileUp: <g><path d="M14.5 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7.5L14.5 2z" /><polyline points="14 2 14 8 20 8" /><path d="M12 12v6" /><path d="M9 15l3-3 3 3" /></g>,
...
window.SimpleIcon = ({ name, className }) => {
    ...
    return <window.Icon path={window.Icons[name]} className={className} />;
};
